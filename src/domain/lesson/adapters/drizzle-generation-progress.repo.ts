...
/**
 * Drizzle implementation of `GenerationProgressRepository`.
 * Records and queries durable generation progress: milestones and thoughts.
 * Milestones use idempotent insert (WHERE NOT EXISTS) to survive worker retries.
 * Thoughts are deduplicated against the latest recorded thought.
 */
