...
/**
 * Drizzle implementation of `GenerationJobRepository`.
 * Manages the GenerationJob queue: claiming jobs via FOR UPDATE SKIP LOCKED,
 * updating job status, asserting queue capacity, and resetting stuck jobs.
 */
