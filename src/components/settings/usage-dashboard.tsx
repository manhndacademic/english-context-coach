...
function RecentRequestsTable({
  ...
  handleCopyDiagnostics: (req: any) => void;
}) {
  return (
    <div className="bg-background border border-border rounded-lg p-4 sm:p-5">
      <h3 className="text-sm font-bold text-text uppercase tracking-wider mb-4 mt-0">
            ...
            {recent.length > 0 ? (
              recent.flatMap((req: any) => {
                ...
                return [
                  ...
                  isExpanded && (
                    <tr key={`${req.id}-details`} className="bg-danger-light/5">
                        ...
                        <div className="grid gap-3">
                          ...
                          <div className="flex gap-3 justify-end items-center">
                            <span className="text-muted text-[10px]">
                              Hãy chụp màn hình hoặc sao chép thông tin này gửi
                              cho kỹ thuật.
                            </span>
                            <button
                              type="button"
...
Thông điệp lỗi: ${req.errorMessage || "Không có thông điệp lỗi chi tiết."}`;
  ...
  return (
    <SectionCard className="p-5 sm:p-8 gap-6">
      ...
      <UsageStatsChart formattedChartData={formattedChartData} daily={daily} />
