...
| `GEMINI_MAX_OUTPUT_TOKENS_GRADING`  | Max output token limit for attempt grading.           | Defaults to `700`.                                                                                                                                     |
| `GEMINI_MAX_OUTPUT_TOKENS_REPAIR`   | Max output token limit for JSON response repair.      | Defaults to `1200`.                                                                                                                                    |
