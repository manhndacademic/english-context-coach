...
| `GEMINI_MAX_OUTPUT_TOKENS_ANALYSIS` | Giới hạn token đầu ra tối đa cho phân tích bài học.           | Mặc định là `8192` (Giới hạn đầu ra tối đa của Gemini).                                                                                                       |
| `GEMINI_MAX_OUTPUT_TOKENS_EXERCISE` | Giới hạn token đầu ra tối đa cho việc sinh bài tập.           | Mặc định là `2200`.                                                                                                                                           |
| `GEMINI_MAX_OUTPUT_TOKENS_GRADING`  | Giới hạn token đầu ra tối đa cho việc chấm điểm bài làm.      | Mặc định là `4096`.                                                                                                                                           |
| `GEMINI_MAX_OUTPUT_TOKENS_REPAIR`   | Giới hạn token đầu ra tối đa cho việc sửa lỗi phản hồi JSON.  | Mặc định là `4096`.                                                                                                                                           |
