...
| `GEMINI_MAX_OUTPUT_TOKENS_GRADING`  | Giới hạn token đầu ra tối đa cho việc chấm điểm bài làm.      | Mặc định là `700`.                                                                                                                                            |
| `GEMINI_MAX_OUTPUT_TOKENS_REPAIR`   | Giới hạn token đầu ra tối đa cho việc sửa lỗi phản hồi JSON.  | Mặc định là `1200`.                                                                                                                                           |
